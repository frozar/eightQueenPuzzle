...
var author$project$Main$NothingSelected = {$: 2};
...
var author$project$Main$initQueens = A2(
...
var author$project$Main$init = {h: author$project$Main$initBoard, p: _List_Nil, k: author$project$Main$initQueens, b: author$project$Main$NothingSelected};
...
var author$project$Main$hasQueenAt = F3(
	function (board, iPlace, jPlace) {
		...
		if (!_n0.$) {
			var arrayQueen = _n0.a;
			var _n1 = A2(elm$core$Array$get, jPlace, arrayQueen);
			if (!_n1.$) {
				var maybeQueen = _n1.a;
				return maybeQueen;
			} else {
				return elm$core$Maybe$Nothing;
			}
...
var author$project$Main$placeQueen = F4(
	function (board, queen, iPlace, jPlace) {
		return A2(
			...
			F2(
				function (i, arrayQueen) {
					return A2(
						elm$core$Array$indexedMap,
						F2(
							function (j, maybeQueen) {
								if (_Utils_eq(i, iPlace) && _Utils_eq(j, jPlace)) {
									return elm$core$Maybe$Just(queen);
								} else {
									if (!maybeQueen.$) {
										var q = maybeQueen.a;
										return _Utils_eq(q, queen) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(q);
									} else {
										return elm$core$Maybe$Nothing;
									}
								}
...
var elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {e: builder.e, a: builder.a, d: appended});
	});
...
var author$project$Main$getQueenPositionRow = F4(
	function (i, j, maybeQueens, listPosition) {
		getQueenPositionRow:
		while (true) {
			var _n0 = A2(elm$core$Array$get, 0, maybeQueens);
			if (!_n0.$) {
				var maybeQueen = _n0.a;
				if (!maybeQueen.$) {
					...
					i = $temp$i;
					j = $temp$j;
					maybeQueens = $temp$maybeQueens;
					listPosition = $temp$listPosition;
					continue getQueenPositionRow;
				} else {
					var $temp$i = i,
						$temp$j = j + 1,
						$temp$maybeQueens = A2(author$project$Main$arrayDrop, 1, maybeQueens),
...
var author$project$Main$getQueenAgainst = F2(
	function (listQueenPosition, res) {
		getQueenAgainst:
		while (true) {
			var _n0 = elm$core$List$head(listQueenPosition);
			if (!_n0.$) {
				var _n1 = _n0.a;
				var i = _n1.a;
				var j = _n1.b;
				var listQueenAgainst = A2(
					...
					function (pos) {
						return A2(
							...
							_Utils_Tuple2(
								_Utils_Tuple2(i, j),
								pos)) : elm$core$Maybe$Nothing;
					},
					A2(elm$core$List$drop, 1, listQueenPosition));
				var $temp$listQueenPosition = A2(elm$core$List$drop, 1, listQueenPosition),
					$temp$res = A2(elm$core$List$append, listQueenAgainst, res);
				listQueenPosition = $temp$listQueenPosition;
				res = $temp$res;
				continue getQueenAgainst;
			} else {
				return res;
			}
		}
	...
	function (msg, model) {
		switch (msg.$) {
				...
				switch (_n1.$) {
					case 0:
						...
						return _Utils_eq(queen, selectedAvailableQueen) ? _Utils_update(
							model,
							{b: author$project$Main$NothingSelected}) : _Utils_update(
							model,
							{
								b: author$project$Main$Available(queen)
							});
					case 1:
			...
			case 1:
				var i = msg.a;
				var j = msg.b;
				var _n2 = A3(author$project$Main$hasQueenAt, model.h, i, j);
				if (!_n2.$) {
					var queen = _n2.a;
					var _n3 = model.b;
					switch (_n3.$) {
						case 1:
							...
							if (_Utils_eq(alreadySelectedQueen, queen)) {
								var updatedBoard = A2(author$project$Main$removeQueenBoard, model.h, queen);
								return _Utils_update(
									model,
									{
										h: updatedBoard,
										p: author$project$Main$updateQueenAgainst(updatedBoard),
										k: A2(elm$core$List$cons, alreadySelectedQueen, model.k),
										b: author$project$Main$NothingSelected
									});
							} else {
								return _Utils_update(
									model,
									{
										b: author$project$Main$Placed(queen)
									});
							}
						case 0:
							var alreadySelectedQueen = _n3.a;
					...
					switch (_n4.$) {
						case 0:
							var queen = _n4.a;
							var updatedBoard = A4(author$project$Main$placeQueen, model.h, queen, i, j);
							return _Utils_update(
								model,
								{
									h: updatedBoard,
									p: author$project$Main$updateQueenAgainst(updatedBoard),
									k: A2(author$project$Main$removeQueenAvailable, queen, model.k),
									b: author$project$Main$NothingSelected
								});
						case 1:
							var queen = _n4.a;
			...
			default:
				return _Utils_update(
					model,
					{h: author$project$Main$initBoard, p: _List_Nil, k: author$project$Main$initQueens, b: author$project$Main$NothingSelected});
		}
	});
...
var author$project$Main$isCellBetweenAgainstQueen = F2(
	function (_n0, _n1) {
		...
		var i1 = _n3.a;
		var j1 = _n3.b;
		return _Utils_eq(i0, i1) ? (_Utils_eq(i, i0) && (((_Utils_cmp(j0, j) < 0) && (_Utils_cmp(j, j1) < 0)) || ((_Utils_cmp(j1, j) < 0) && (_Utils_cmp(j, j0) < 0)))) : (_Utils_eq(j0, j1) ? (_Utils_eq(j, j0) && (((_Utils_cmp(i0, i) < 0) && (_Utils_cmp(i, i1) < 0)) || ((_Utils_cmp(i1, i) < 0) && (_Utils_cmp(i, i0) < 0)))) : (((0 < (i1 - i0)) && ((0 < (j1 - j0)) && _Utils_eq(i1 - i0, j1 - j0))) ? ((_Utils_cmp(i0, i) < 0) && ((_Utils_cmp(i, i1) < 0) && ((_Utils_cmp(j0, j) < 0) && ((_Utils_cmp(j, j1) < 0) && _Utils_eq(i - i0, j - j0))))) : (((0 < (i1 - i0)) && ((0 < (j0 - j1)) && _Utils_eq(i1 - i0, j0 - j1))) ? ((_Utils_cmp(i0, i) < 0) && ((_Utils_cmp(i, i1) < 0) && ((_Utils_cmp(j1, j) < 0) && ((_Utils_cmp(j, j0) < 0) && _Utils_eq(i - i0, j - j1))))) : (((0 < (i0 - i1)) && ((0 < (j1 - j0)) && _Utils_eq(i0 - i1, j1 - j0))) ? ((_Utils_cmp(i1, i) < 0) && ((_Utils_cmp(i, i0) < 0) && ((_Utils_cmp(j0, j) < 0) && ((_Utils_cmp(j, j1) < 0) && _Utils_eq(i - i1, j - j0))))) : (((0 < (i0 - i1)) && ((0 < (j0 - j1)) && _Utils_eq(i0 - i1, j0 - j1))) ? ((_Utils_cmp(i1, i) < 0) && ((_Utils_cmp(i, i0) < 0) && ((_Utils_cmp(j1, j) < 0) && ((_Utils_cmp(j, j0) < 0) && _Utils_eq(i - i1, j - j1))))) : false)))));
	});
...
var author$project$Main$isSelected = F2(
	function (selectedQueen, q0) {
		switch (selectedQueen.$) {
			case 0:
				var q1 = selectedQueen.a;
				return _Utils_eq(q0, q1);
			case 1:
				var q1 = selectedQueen.a;
				return _Utils_eq(q0, q1);
			default:
...
var author$project$Main$viewBoardCell = F5(
	function (selectedQueen, queenAgainst, maybeQueen, i, j) {
		return A2(
			...
			_List_fromArray(
				[
					A2(elm$html$Html$Attributes$style, 'border', '1px solid #505050'),
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$style,
									'color',
									(!A2(elm$core$Basics$modBy, 2, i + j)) ? 'white' : 'black')
								]),
							_List_fromArray(
								[
									A2(
...
var author$project$Main$viewVictory = function (model) {
	return (elm$core$List$isEmpty(model.k) && elm$core$List$isEmpty(model.p)) ? elm$html$Html$text('VICTORY') : elm$html$Html$text('');
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(author$project$Main$viewBoard, model.h, model.b, model.p),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						A2(
							elm$core$List$map,
							author$project$Main$viewQueen(model.b),
							model.k))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Main$viewVictory(model)
							]))
					])),
				A2(
				elm$html$Html$div,
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{av: author$project$Main$init, aD: author$project$Main$update, aF: author$project$Main$view});
